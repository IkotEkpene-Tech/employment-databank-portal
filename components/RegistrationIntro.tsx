  ...
  return (
    <div className="bg-[#FFFFFF] shadow-lg rounded-lg border p-6 mb-6 animate-fade-in">
      <h2 className="text-lg font-semibold text-[#00572f] mb-3">
        Welcome to the Official Databank Initiative
      </h2>
      <p className="text-[#5c7166] mb-4">
        Under the Chairmanship of <strong>Hon. Elder Aniefiok Nkom</strong>, this portal
        collects structured data of eligible indigenes of Ikot Ekpene LGA who
        are unemployed, underemployed, or actively seeking better job
        opportunities.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        <div className="flex items-start gap-3 p-3 bg-[#eff1f0] rounded-lg">
          ...
          <div>
            <h3 className="font-medium text-sm text-[#112219]">Job Placement</h3>
            <p className="text-xs text-[#5c7166]">
        ...
        <div className="flex items-start gap-3 p-3 bg-[#eff1f0] rounded-lg">
          ...
          <div>
            <h3 className="font-medium text-sm text-[#112219]">Skills Training</h3>
            <p className="text-xs text-[#5c7166]">
        ...
        <div className="flex items-start gap-3 p-3 bg-[#eff1f0] rounded-lg">
          ...
          <div>
            <h3 className="font-medium text-sm text-[#112219]">Opportunities</h3>
